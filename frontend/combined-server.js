...
console.log('⚙️  Security disabled with EXPO_OFFLINE=1');
const expo = spawn('npx', ['expo', 'start', '--web', '--port', PORT.toString(), '--host', 'lan'], {
  cwd: __dirname,
  stdio: 'inherit',
  env: { 
    ...process.env, 
    ...
    EXPO_OFFLINE: '1',
    REPL_ID: process.env.REPL_ID || 'development',
    CI: '1'
  }
});
