...
const menuItems = [
    ...
    // Production Section
    {
      ...
      subItems: [
        ...
        { name: "Pipeline View", route: "ProductionPipeline", icon: SvgRouteIcon },
        ...
        { name: "Raw Wheat Transfer", route: "PrecleaningBin", icon: SvgBinIcon },
        { name: "Magnets Cleaning", route: "MagnetCleaning", icon: SvgBinIcon },
    ...
    // Dispatch Section
    {
      ...
      subItems: [
        ...
        { name: "Driver View", route: "DriverView", icon: SvgTruckIcon },
        { name: "Trip Sheet (Admin)", route: "TripSheet", icon: SvgFileTextIcon },
