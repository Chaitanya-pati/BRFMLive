...
export default function SupplierMasterScreen({ navigation }) {
  ...
  const columns = [
    { label: 'Supplier Name', field: 'supplier_name', width: 220, key: 'supplier_name' },
    { label: 'Contact Person', field: 'contact_person', width: 180, key: 'contact_person' },
    { label: 'Phone', field: 'phone', width: 140, key: 'phone' },
    { label: 'State', field: 'state', width: 140, key: 'state' },
    { label: 'City', field: 'city', width: 140, key: 'city' },
  ];
