...
import TruckMasterScreen from './src/screens/TruckMasterScreen';
import CustomerOrderMasterScreen from './src/screens/CustomerOrderMasterScreen';
    ...
    <>
      ...
      >
        {isLoading ? (
          ...
          <Stack.Screen name="CustomerOrderMaster" component={CustomerOrderMasterScreen} />
          ...
          <Stack.Screen name="FinishedGoodsManagement" component={FinishedGoodsManagementScreen} />
          <Stack.Screen name="GodownStockView" component={GodownStockViewScreen} />
          ...
          <Stack.Screen name="DeliveryBills" component={DeliveryBillsScreen} />
          <Stack.Screen name="BranchBillProfile" component={BranchBillProfileScreen} />
